...
myXmobarPP =
  def
    ...
    , ppTitle = wrap (xmobarColor colorCyn "" "[") (xmobarColor colorCyn "" "]") . xmobarColor colorFg "" . shorten 50
...
myStatusBar = statusBarProp "xmobar ~/.config/xmonad/xmobarrc" (pure myXmobarPP)
