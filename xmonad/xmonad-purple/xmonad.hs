  ...
  xmonad $ docks . ewmhFullscreen . ewmh $
    additionalKeys
      ...
      , ((0, xF86XK_AudioLowerVolume),
         spawn "wpctl set-volume @DEFAULT_AUDIO_SINK@ -5% && notify-send 'Volume' 'Decreased by 5%'")
      , ((0, xF86XK_AudioRaiseVolume),
         spawn "wpctl set-volume @DEFAULT_AUDIO_SINK@  5%+ && notify-send 'Volume' 'Increased by 5%'")
      , ((0, xF86XK_AudioMute),
         spawn "wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && notify-send 'Volume' 'Muted/Unmuted'")
        -- Brightness
