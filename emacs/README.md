...
- `libc6-dev`
- `texinfo`
- Development libraries: `libgccjit-dev`, `libasound2-dev`, `libgnutls-dev`, `libxml2-dev`, `libncurses5-dev`, `libharfbuzz-dev`, `libgtk3.0-dev`, `libx11-dev`, `libxpm-dev`, `libjpeg-dev`, `libpng-dev`, `libgif-dev`, `libtiff-dev`,  `libwebp-dev`, `librsvg2-dev`, `libdbus-1-dev`, `libwebkit2gtk-4.1-dev`, `libtree-sitter-dev`, `libsystemd-dev`, `libcairo-dev`.
...
**Basic Configuration For X11 (Recommended):**
...
```
**Basic Configuration For Wayland (Recommended):**
...
## To use my main config

```
sudo cp -r main/* ~/.config/emacs/
``` 

## To use my minimal config

```
sudo cp minimal/init.el ~/.config/emacs/
```
